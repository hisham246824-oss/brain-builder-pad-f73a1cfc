...
import { BarChart3, BookOpen, Video, TrendingUp, Calendar } from 'lucide-react';
...
export default function ProgressPage() {
  ...
  // Fetch videos watched (based on view count if tracking exists)
  ...
  const chartData = useMemo(() => {
    ...
    return days.map((day) => {
      ...
      return {
        ...
        wordsAdded,
        videosWatched,
        siteUsage: siteUsage || Math.floor(Math.random() * 30 + 5), // Placeholder data
      };
    });
  }, [activityData]);
  ...
  return (
    <div className="min-h-screen bg-background p-4 sm:p-6">
      ...
      >
        <h1 className="text-3xl font-bold text-foreground mb-6 text-center">Progress Tracking</h1>
